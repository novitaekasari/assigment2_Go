...
type OrderService interface {
	...
	DeletedOrder(orderId int) (*dto.GetOrdersResponse, errs.Error)
}
...
// DeletedOrder implements OrderService.
func (os *orderService) DeletedOrder(orderId int) (*dto.GetOrdersResponse, errs.Error) {
	err := os.OrderRepo.DeletedOrder(orderId)
	...
	return &dto.GetOrdersResponse{
		StatusCode: http.StatusOK,
		Message: "delete oredr succesfully",
		Data: nil,
	}, nil
